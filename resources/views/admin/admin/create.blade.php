...
@section('content')
    ...
    <center><h1>添加管理<a style="float:right" href="{{url('/admin')}}" type="button" class="btn btn-info">列表</a></h1></center><hr/>
...
{{--            </div>--}}
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="firstname" name="moblie"
                           placeholder="请输入手机号">
                </div>
            </div>
        <div class="form-group">
