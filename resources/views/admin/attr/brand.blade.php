...
<a href="/">首页</a>
<a href="/goodstypest">类型管理</a>
<a><cite>属性添加</cite></a>
</span>
    <center><h1>属性添加</h1></center><hr/>
    <form action="{{url('/attr/store')}}" method="POST" class="form-horizontal" role="form" enctype="multipart/form-data">
            ...
            <div class="col-sm-offset-2 col-sm-10">
                <button type="submit" id="create" class="btn btn-default">添加</button>
                        <button type="reset" class="btn btn-default">重置</button>
                                <a href="/attrst" class="btn btn-default">前往列表</a>
            </div>
        </div>
    </form>
