...
@section('title', '秒杀')
@section('content')
<form action="{{url('/seckil/store')}}" method="post" name="theForm" enctype="multipart/form-data" onsubmit="return validate()">
...
{{--        <form class="layui-form layui-form-pane" action="/adver/store" method="POST" enctype="multipart/form-data">--}}
            ...
            <div class="form-group">
                ...
                <div class="layui-upload-drag" id="test1">
                    <input type="hidden" id="fileview1" name="goods_img" value="">
