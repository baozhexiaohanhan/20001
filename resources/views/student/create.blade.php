...
<form action="{{url('student/store')}}" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
			...
			<div class="layui-tab-item">
				<table width="90%" id="mix-table" class="layui-table" align="center">
					<tbody><tr>
							...
							<tr>
							<td class="green"><a href="javascript:showNotice('noticeStorage');" title="点击此处查看提示信息"><img src="images/notice.svg" width="16" height="16" border="0" alt="点击此处查看提示信息"></a> 商品库存数量：</td>
	<!--            <td><input type="text" name="goods_number" value="1" size="20"  /><br />-->
						...
						<tr>
							<td class="green">
							<a href="javascript:showNotice('noticeSellerNote');"><img src="images/notice.svg" width="16" height="16" border="0"></a> 商家备注： </td>
